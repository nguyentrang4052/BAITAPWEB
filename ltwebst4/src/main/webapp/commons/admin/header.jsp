				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown dropdown-user dropdown-dark"><a
						...
						data-hover="dropdown" data-close-others="true"> <img alt=""
							class="img-circle"
							src="sassets/admin/layout3/img/avatar9.jpg"> <span
		...
		<div class="container">
			...
			<div class="hor-menu ">
				<ul class="nav navbar-nav">
									...
									<div class="row">
										<div class="col-md-4">
											<ul class="mega-menu-submenu">
												...
												<li><a href="ecommerce_orders.html" class="iconify">
														<i class="icon-basket"></i> Manage Orders
												</a></li>
					...
					<li class="menu-dropdown"><a href="angularjs" target="_blank"
						class="tooltips" data-container="body" data-placement="bottom"
						data-html="true" data-original-title="AngularJS version demo">
							AngularJS Version </a></li>
				</ul>
			</div>
			<!-- END MEGA MENU -->
		</div>
